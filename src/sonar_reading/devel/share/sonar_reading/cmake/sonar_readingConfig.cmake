...
if("TRUE" STREQUAL "TRUE")
  ...
  set(sonar_reading_DEVEL_PREFIX /home/pi/projeto/src/sonar_reading/devel)
  ...
  set(sonar_reading_INSTALL_PREFIX /usr/local)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'sonar_reading' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/projeto/src/sonar_reading/${idir}'.  Ask the maintainer 'pi <pi@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/projeto/src/sonar_reading/devel/lib;/home/pi/workshop/devel/lib;/opt/ros/indigo/lib)
